...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        ...
        for snippet_plugin in orm.Snippet.objects.all():
            if snippet_plugin.snippet.template:
                snippet_plugin.template = snippet_plugin.snippet.template
                snippet_plugin.save()
            else:
                snippet_plugin.delete()

    def backwards(self, orm):
        "Write your backwards methods here."
        for snippet_plugin in orm.Snippet.objects.all():
            snippet_plugin.snippet.template = snippet_plugin.template
            snippet_plugin.snippet.save()
