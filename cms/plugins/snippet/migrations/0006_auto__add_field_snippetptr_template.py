...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'SnippetPtr.template'
        db.add_column('cmsplugin_snippetptr', 'template',
                      self.gf('django.db.models.fields.CharField')(default='', max_length=100),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'SnippetPtr.template'
        db.delete_column('cmsplugin_snippetptr', 'template')
